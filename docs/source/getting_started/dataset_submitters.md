...
- Access to the project config file and optionally the project registry
  - The config file is typically available in a project-specific repository
...
- See [How to Run dsgrid on Kestrel](../user_guide/how_tos/run_on_kestrel) for running on NLR HPC

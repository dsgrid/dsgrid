...
- **Big Data Support**: Process terabyte-scale datasets using Apache Spark or DuckDB
...
- **NREL dsgrid Page**: Visit [https://www.nrel.gov/analysis/dsgrid.html](https://www.nrel.gov/analysis/dsgrid.html)

...
class DatasetConfigModel(DSGBaseModel):
    ...
    data_schema: Annotated[
        Union[StandardDataSchemaModel, OneTableDataSchemaModel],
        Field(
            title="data_schema",
    ...
    enable_unit_conversion: Annotated[
        bool,
        Field(
            default=True,
    ...
    use_project_geography_time_zone: Annotated[
        bool,
        Field(
            default=False,
    ...
    dimension_references: Annotated[
    ...
    user_defined_metadata: Annotated[
        Dict,
        Field(
    ...
    trivial_dimensions: Annotated[
        Optional[List[DimensionType]],
        Field(

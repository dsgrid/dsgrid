...
class DimensionMappingBaseModel(DSGBaseModel):
    ...
    archetype: Annotated[
        Optional[DimensionMappingArchetype],
        Field(
            None,
            title="archetype",
    ...
    from_fraction_tolerance: Annotated[
        float,
        Field(
